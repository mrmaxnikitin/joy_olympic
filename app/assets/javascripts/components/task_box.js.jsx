        ...
        <div className='participate-page'>
          <div className='participate-result animated bounceIn'>
            ...
            <div className='user-data'>
              ...
              <div>
                <input className='tac' ref='age' type='text' placeholder='Класс (группа, возраст и т.д.)' maxLength="44" />
              </div>
              <div>
                <input className='tac' ref='institution' type='text' placeholder='Учебное заведение' maxLength="70" />
              </div>
            </div>

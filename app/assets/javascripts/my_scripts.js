    ...
    $('#buy-diploma').click(function(){
		...
		$('.custEmail').change(function(){
			custEmail = $('.custEmail').val()
    	  		$('.ym_merchant_receipt').val('{\"customerContact\":\"'+custEmail+'\",\"taxSystem\": 2,\"items\": [{\"quantity\": 1,\"price\": {\"amount\": 100.00},\"tax\": 1,\"text\": \"Услуги по обработке данных\", \"paymentMethodType\": \"full_prepayment\", \"paymentSubjectType\": \"payment\"}]}')
	 	});
